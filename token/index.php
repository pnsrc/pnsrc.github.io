...
<main role="main" class="container">
  ...
  <div class="starter-template">
    <p class="lead">Пока я не разобрался как полностью работает WebView, вот будет вам костыль...</p></br>
    <div class="timeago" datetime="2016-06-30 09:20:00"></div>
    <a href="https://login.dnevnik.ru/oauth2?response_type=token&client_id=b8006d7570a94291885c13d8511bb2ae&scope=CommonInfo,FriendsAndRelatives,EducationalInfo&redirect_uri=https://<?php echo $_SERVER["HTTP_HOST"];?>/token/token.php" class="btn btn-success btn-lg " role="button" aria-disabled="true">Получить токен</a>
